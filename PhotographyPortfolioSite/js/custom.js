...
$(document).ready(function(e) {
	...
	$("#photographer1_click").click(function(){
        $("#photographer2").hide();
	    $("#photographer3").hide();
		$("#photographer4").hide();
		$("#photographer5").hide();
    ...
    $("#photographer2_click").click(function(){
		$("#photographer1").hide();
	    $("#photographer3").hide();
		$("#photographer4").hide();
		$("#photographer5").hide();
	...
	$("#photographer3_click").click(function(){
        $("#photographer2").hide();
	    $("#photographer1").hide();
		$("#photographer4").hide();
		$("#photographer5").hide();
    ...
    $("#photographer4_click").click(function(){
		$("#photographer1").hide();
	    $("#photographer3").hide();
		$("#photographer2").hide();
		$("#photographer5").hide();
    ...
    $("#photographer5_click").click(function(){
		$("#photographer1").hide();
	    $("#photographer3").hide();
		$("#photographer4").hide();
		$("#photographer2").hide();
